...
namespace ProyectoFinal.Controllers
{
    public class PermisosController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "ID,IdEmpleado,Desde,Hasta,Comentarios")] Permisos permisos)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ID,IdEmpleado,Desde,Hasta,Comentarios")] Permisos permisos)
        {
            if (ModelState.IsValid)
            {
