...
namespace ProyectoFinal.Controllers
{
    public class LicenciasController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "ID,IdEmpleado,Desde,Hasta,Motivo,Comentarios")] Licencias licencias)
        {
            ...
            ViewBag.IdEmpleado = new SelectList(db.Empleados, "Id", "Nombre", licencias.IdEmpleado);
            return View(licencias);
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ID,IdEmpleado,Desde,Hasta,Motivo,Comentarios")] Licencias licencias)
        {
            if (ModelState.IsValid)
            {
