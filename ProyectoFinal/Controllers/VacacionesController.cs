...
namespace ProyectoFinal.Controllers
{
    public class VacacionesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "ID,IdEmpleado,CorrespondientealAÑO,Comentarios,Desde,Hasta")] Vacaciones vacaciones)
        {
            ...
            ViewBag.IdEmpleado = new SelectList(db.Empleados, "Id", "Nombre", vacaciones.IdEmpleado);
            return View(vacaciones);
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ID,IdEmpleado,CorrespondientealAÑO,Comentarios,Desde,Hasta")] Vacaciones vacaciones)
        {
            if (ModelState.IsValid)
            {
